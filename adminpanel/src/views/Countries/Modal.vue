    ...
    <div class="modal-mask-1">
      <div class="modalBody">
        ...
        <div class="row">
          <div class="col-lg-2"></div>
          <div class="col-lg-6">
            <input class="col-lg-12 form-control" type="text" placeholder="Код" v-model="inheritCode" />
          </div>
          <div class="col-lg-4"></div>
        </div>
        <div class="row">
...
export default {
  ...
  data() {
    return {
      ...
      inheritCode: this.code
    };
  },
  methods: {
    send: function() {
      if (this.inheritTitle != "" && this.inheritCode != "") {
        let obj = {
          name: this.inheritTitle,
          code: this.inheritCode,
          id: this.id
        };
        admin_API
          .post("update-country", JSON.stringify(obj))
          .then(response => {
