    ...
    <div class="modal-mask-1">
      <div class="modalBody">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <input class="col-lg-12 form-control" type="text" placeholder="Название" v-model="title" />
          </div>
        ...
        <div class="row">
          <div class="col-lg-2"></div>
          <div class="col-lg-6">
            <input class="col-lg-12 form-control" type="text" placeholder="Код" v-model="code" />
          </div>
          <div class="col-lg-4"></div>
        </div>
        <div class="row">
  ...
  methods: {
    send: function() {
      if (this.title != "" && this.code != "") {
        ...
        admin_API
          .post("add-country", JSON.stringify(obj))
          .then(response => {
