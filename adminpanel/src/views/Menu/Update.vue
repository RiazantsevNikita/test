  ...
  <div id="page-wrapper">
    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <input type="checkbox" v-model="mobile" disabled />
      </div>
      <div class="col-lg-4">
      ...
      <div class="col-lg-4">
        <span>Компания:</span>
        <select v-model="company" class="form-control" disabled>
          <option
...
export default {
  ...
  mounted() {
    ...
    API.post("get-menu", {id: this.$route.params.id}).then((response) => {
      console.log(response.data);
      this.menu = response.data.menu;
      this.country = response.data.country._id;
      this.company = response.data.company._id;
